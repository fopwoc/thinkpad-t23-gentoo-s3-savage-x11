...
# $Header: /var/cvsroot/gentoo-x86/x11-base/xorg-server/xorg-server-1.12.4-r4.ebuild,v 1.10 2015/03/17 18:41:00 chithanh Exp $
...
SRC_URI="https://www.x.org/releases/individual/xserver/xorg-server-1.12.4.tar.gz"
...
src_prepare() {
	epatch "${FILESDIR}"/xorg-server-1.12-fix.patch
	epatch "${FILESDIR}"/xorg-server-1.12-cve-2013-1940.patch
	epatch "${FILESDIR}"/xorg-server-1.12-cve-2013-4396.patch
	epatch "${FILESDIR}"/xorg-server-1.12-disable-acpi.patch
	epatch "${FILESDIR}"/xorg-server-1.12-ia64-fix_inx_outx.patch
	epatch "${FILESDIR}"/xorg-server-1.12-unloadsubmodule.patch
	epatch "${FILESDIR}"/xorg-server-1.17-cve-2015-0255-0.patch
	epatch "${FILESDIR}"/xorg-server-1.17-cve-2015-0255-1.patch
}
